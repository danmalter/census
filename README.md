...
[![Build Status](https://travis-ci.org/danmalter/censusR)](https://travis-ci.org/danmalter/censusR.svg?branch=master)[![CRAN Badge](https://www.r-pkg.org/badges/version/censusapi)](https://cran.r-project.org/package=censusapi)
