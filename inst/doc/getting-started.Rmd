...
Notice that fields like AvgFamInc and MedianHValue are by default characters with commas.  These fields need to be properly converted into numeric values if further analysis is going to be done.
